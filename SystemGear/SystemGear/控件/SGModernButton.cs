...
namespace SystemGear
{
    ...
    public partial class SGModernButton : UserControl
    {
       ...
       public enum ButtonStyle { Normal, NormalWithLogo, NormalWithoutBackPage }
        ...
        private ContentAlignment _textalig = ContentAlignment.MiddleLeft;
        #endregion
        #region 属性
        ...
        [Browsable(true), Category("TextBoxSettings"), Description("设置按钮的文字的布局")]
        ...
        {
            if (btnstye == ButtonStyle.NormalWithoutBackPage )
            {
